...
TooltipContentWithoutPortal.displayName = 'TooltipContentWithoutPortal'

export { Tooltip, TooltipTrigger, TooltipContent, TooltipProvider, TooltipContentWithoutPortal }
